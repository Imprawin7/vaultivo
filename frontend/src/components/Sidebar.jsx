  ...
  return (
    <aside className="w-60 shrink-0 bg-ink text-paper flex flex-col h-full">
      ...
      <div className="px-4 mb-4 flex flex-col gap-2">
        ...
        <button
          onClick={onNewFolder}
          className="inline-flex items-center gap-2 justify-center px-4 py-2 text-sm font-medium rounded-ticket border border-paper/20 text-paper/90 hover:bg-paper/5 transition-colors duration-150"
        >
          <FolderPlusIcon />
          New folder
        </button>
...
function DriveIcon() {
  return (
    ...
    >
      <path
        d="M3 7l3-4h12l3 4M3 7v11a2 2 0 002 2h14a2 2 0 002-2V7M3 7h18"
        strokeLinecap="round"
...
function TagIcon() {
  return (
    ...
    >
      <path
        d="M12.5 3H5a2 2 0 00-2 2v7.5a2 2 0 00.6 1.4l9 9a2 2 0 002.8 0l6.5-6.5a2 2 0 000-2.8l-9-9a2 2 0 00-.4-1.6z"
        strokeLinejoin="round"
      />
      <circle
        cx="8"
...
function FolderPlusIcon() {
  return (
    ...
    >
      <path
        d="M3 7l1.5-2h6L12 7h9v11a2 2 0 01-2 2H5a2 2 0 01-2-2V7z"
        strokeLinejoin="round"
      />
      <path
        d="M12 12v4M10 14h4"
